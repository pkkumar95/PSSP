...
with tf.device('/device:GPU:0'):
    ...
    #One layer of Convolutional 2D and one layer of Max pooling 2D
    ...
    load_file = "./model/UC_Q3_cnn_blstm.h5"
    ...
    print("#########evaluate UC_Q3_cnn_blstm:##############")
    ...
    with open('./results_cnn_blstm/cb6133/cb6133_pred.csv', 'w+') as file:
        ...
        for i in range(testlabel_6133.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_cnn_blstm/cb6133/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_cnn_blstm/cb6133/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()
    ...
    with open('./results_cnn_blstm/cb513/cb513_pred.csv', 'w+') as file:
        fields = ['pdb_id', 'y_true', 'y_pred']
        writer = csv.DictWriter(file, fieldnames=fields)
        writer.writeheader()
        seq_t = str()
        ...
        for i in range(testlabel_513.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_cnn_blstm/cb513/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_cnn_blstm/cb513/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()
    ...
    with open('./results_cnn_blstm/casp10/casp10_pred.csv', 'w+') as file:
        fields = ['pdb_id', 'y_true', 'y_pred']
        writer = csv.DictWriter(file, fieldnames=fields)
        writer.writeheader()
        seq_t = str()
        ...
        for i in range(testlabel_10.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_cnn_blstm/casp10/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_cnn_blstm/casp10/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()
    ...
    with open('./results_cnn_blstm/casp11/casp11_pred.csv', 'w+') as file:
        fields = ['pdb_id', 'y_true', 'y_pred']
        writer = csv.DictWriter(file, fieldnames=fields)
        writer.writeheader()
        seq_t = str()
        ...
        for i in range(testlabel_11.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_cnn_blstm/casp11/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_cnn_blstm/casp11/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()

...
with tf.device('/device:GPU:2'):
    ...
    f2 = GRU(250, return_sequences=True, activation='tanh', recurrent_activation='sigmoid', dropout=0.2, recurrent_dropout=0.2, go_backwards=True)(d_output)
    
    f3 = GRU(250, return_sequences=True, activation='tanh', recurrent_activation='sigmoid', dropout=0.2, recurrent_dropout=0.2)(f1)
    f4 = GRU(250, return_sequences=True, activation='tanh', recurrent_activation='sigmoid', dropout=0.2, recurrent_dropout=0.2, go_backwards=True)(f2)
    ...
    load_file = "./model/UC_Q3_conv_bgru.h5"
    ...
    print("#########evaluate UC_Q3_conv_bgru:##############")
    ...
    with open('./results_conv_bgru/cb6133/cb6133_pred.csv', 'w+') as file:
        ...
        for i in range(testlabel_6133.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_conv_bgru/cb6133/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_conv_bgru/cb6133/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()
    ...
    with open('./results_conv_bgru/cb513/cb513_pred.csv', 'w+') as file:
        fields = ['pdb_id', 'y_true', 'y_pred']
        writer = csv.DictWriter(file, fieldnames=fields)
        writer.writeheader()
        seq_t = str()
        ...
        for i in range(testlabel_513.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_conv_bgru/cb513/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_conv_bgru/cb513/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()
    ...
    with open('./results_conv_bgru/casp10/casp10_pred.csv', 'w+') as file:
        fields = ['pdb_id', 'y_true', 'y_pred']
        writer = csv.DictWriter(file, fieldnames=fields)
        writer.writeheader()
        seq_t = str()
        ...
        for i in range(testlabel_10.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_conv_bgru/casp10/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_conv_bgru/casp10/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()
    ...
    with open('./results_conv_bgru/casp11/casp11_pred.csv', 'w+') as file:
        fields = ['pdb_id', 'y_true', 'y_pred']
        writer = csv.DictWriter(file, fieldnames=fields)
        writer.writeheader()
        seq_t = str()
        ...
        for i in range(testlabel_11.shape[0]):
            ...
            row['y_pred'] = seq_p
            writer.writerow(row)
            with open('./results_conv_bgru/casp11/in/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_t)
            fasta.close()
            with open('./results_conv_bgru/casp11/out/pdb_'+pdb+'.fasta', 'w+') as fasta:
                fasta.write('>pdb_'+pdb+'\n')
                fasta.write(seq_p)
            fasta.close()
            row = dict()
